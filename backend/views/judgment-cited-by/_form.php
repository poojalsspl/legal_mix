...
<?php
    ...
    //$jcode             = 1; 
    $judegmentCode     = $jcode;
    $judgmentRef = JudgmentCitedBy::find()->where(['judgment_code'=>$judegmentCode])->all();
...
<div class="judgment-ref-form tab-content box box-info col-md-12">
  ...
  <?php foreach ($judgmentRef as $judgmentRefSingle) { ?>
    <tr>
      ...
      <td><?= $judgmentRefSingle->judgment_source_code ?></td>
      <td><?= $judgmentRefSingle->judgment_code_ref ?></td>
      <td><?= $judgmentRefSingle->judgment_source_code_ref ?></td>
