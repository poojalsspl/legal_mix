                    ...
                    <div class="panel panel-default">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">              
                                    ...
                                    <input id="<?='switch' . $key ?>"  onchange="printChecked1(this,<?php echo $value; ?>)" name="plan[]" type="checkbox" id="checkbox" value="<?=$key?>" data-onstyle="success" data-toggle="toggle"/>
