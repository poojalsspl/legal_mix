                    ...
                    <div class="panel panel-default">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                <span class="plan-item">User IP</span>
                                <span class="plan-item-price pull-right">
                                    <input type="text" name="corporate_ip" placeholder="Enter IP like : 192.168.1.48">
                                </span>

                            </li>
                            <li class="list-group-item">              
                                    
                                    <input id="<?='switch' . $key ?>"  onchange="printChecked1(this,<?php echo $value; ?>)" name="court_name[]" type="checkbox" id="checkbox" value="<?=$key?>" data-onstyle="success" data-toggle="toggle"/>
