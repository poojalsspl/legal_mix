                    ...
                    <div class="panel panel-default">
                        ...
                        <ul class="list-group">
                            <?php foreach ($plan_items as $key => $value):?>
                                <?php 
                                     $c_code1 = explode('-', $key);
                                     $c_name = array_shift($c_code1);
                                       //print_r($c_name);


                                ?>
                            <li class="list-group-item">
                                <input  onchange="printChecked(this,<?php echo $value; ?>)" name="court_name[]" type="checkbox" data-width="50" id="checkbox" value="<?= $key?>" data-onstyle="success" data-toggle="toggle"/>
                                <label class="label-blue plan-item-label"><?=$c_name?></label>
                    ...
                    <div class="panel panel-default">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                ...
                                <span class="plan-item-price pull-right">
                                    <input type="text" id="ftotal"  name="ftotal" value="<?php $ftotal ?>" readonly>
                                </span>
                            </li>
