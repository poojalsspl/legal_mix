                            ...
                            <div class="box-body">
                                <div id="exTab2" class="tab-container"> 
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="active"><a href="#2" data-toggle="tab" class="tab-header">CORPORATE</a>
                                        </li>
                                    ...
                                    <div class="tab-content ">
                                        <div class="tab-pane " id="1">
                                            <?php //$this->render('partials/plan_individual', ['plan_items' => (ArrayHelper::map($authItems,'plan','price'))])?>
                                        </div>
                                        <div class="tab-pane active" id="2">
                                            <?=$this->render('partials/plan_corporate', ['plan_items' => (ArrayHelper::map($corpaccess,'plan','price'))])?>
                                        </div>
                                        <div class="tab-pane" id="3">
                                            <?=$this->render('partials/plan_full_access', ['plan_items' => (ArrayHelper::map($fullaccess,'plan','price'))])?>
                                        </div>
                                        </div>
                                </div>
                            </div>
