        ...
        <div class="col-md-12 border-green">
            <div class="row">
                <div class="col-md-12 align-center citation-title">
                  ...
                  <?php
                  if(isset($data["0"]["judgment_title_ref"])):
                  ?>
                
                    <?php echo $data['0']["judgment_title_ref"];?>
     ...
     <div class="row">
                <div class="box box-v2">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-md-6 align-left">
                                <span class="citation-item-text">
                                <a href="<?php echo Url::to(['site/judgment/'.$record["judgment_code"]],true);?>"><?php echo $record["judgment_title"];?></a>
                                </span>
                            </div>
                        </div>
                            <?php $K++; endforeach; ?>
