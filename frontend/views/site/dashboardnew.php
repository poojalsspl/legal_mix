                                ...
                                <div class="col-md-5 col-xs-12">
                                    <div class="row">
                                        <div class="col-md-12 profile-image">
                                            <?=\yii\helpers\Html::img('@web/uploads/' . isset($model->user_pic) ? $model->user_pic : 'default.jpg', ['class' => 'profile-pic'])?>
                                        </div>
                                    </div>
                                    <div class="row">
                                 ...
                                 <div class="col-md-7 col-xs-12 profile-detail">
                                    ...
                                    <div class="row profile-detail-section">
                                        ...
                                        <div class="col-md-8 profile-detail-text"><?=!empty($model->landline_1) ? $model->mobile_2 : '-NA-' ?></div>
                                    </div>
                                    <div class="col-md-4 col-md-offset-4" style="padding-top: 30px;">
                                        <?= \yii\helpers\Html::a('<span><i class="fa fa-pencil"></i></span>  Update Profile', '/site/step2', [
