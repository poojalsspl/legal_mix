  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <?php if (!Yii::$app->user->isGuest){ ?>
       ...
       <!--  <li class="dropdown">
     <a class="dropdown-toggle" data-toggle="dropdown" href="#">CRM <span class="caret"></span></a>
        <ul class="dropdown-menu">
      <li><a href="<?php //Yii::$app->params['domainName'] ?>case-mast/index">Case Diary</a></li>
      <li><a href="<?php //Yii::$app->params['domainName'] ?>cust/index">Customer</a></li>
      <li><a href="<?php //Yii::$app->params['domainName'] ?>invc-mast/index">Invoice</a></li>
    </ul>
  </li> -->
          <?php 
} else { ?>
